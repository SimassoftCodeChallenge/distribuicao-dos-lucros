...
namespace Simasoft.Challenge.Lucro.Dominio.Modelo.DistribuicaoLucros
{
    public sealed class Participacao
    {
        ...
        public Participacao(Funcionario participante, float salarioMinimoRegional)
        {
            ...
            _peso = new Peso(_participante.Area, _participante.SalarioBruto, _participante.DataAdmissao, _salarioMinimoRegional, _participante.Estagiario);
        }
